...
class UserSignUpSerializer(serializers.Serializer):
    ...
    def validate_email(self, email: str):
        ...
        if not AuthAppService.validate_email(email):
            raise serializers.ValidationError(_("Entered email address is not valid."))
        return email
...
class PasswordResetSerializer(auth_serializers.PasswordResetSerializer):
    ...
    email = serializers.EmailField()  # переопределяю
